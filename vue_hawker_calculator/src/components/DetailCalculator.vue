<template>
  <div class="calculator-wrapper">
    ...
    <div class="calculator-keys-wrapper" ref="calculatorWrapperElement">
...
const calculatorWrapperElement = ref(null);
...
onMounted(() => {
  ...
  const calculatorWrapperHeight = calculatorWrapperElement.value.clientHeight;
  if (calculatorWidth > calculatorWrapperHeight) {
    calculatorElement.value.style.height = `${calculatorWrapperHeight}px`;
    calculatorElement.value.style.width = `${calculatorWrapperHeight}px`;
    calculatorDimension.value = calculatorWrapperHeight;
  }

  if (calculatorWidth < calculatorWrapperHeight) {
    calculatorElement.value.style.height = `${calculatorWidth}px`;
    calculatorElement.value.style.width = `${calculatorWidth}px`;
    calculatorDimension.value = calculatorWidth;
  }
});
